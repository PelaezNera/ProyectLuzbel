...
<body>
    ...
    <?php
            ...
            echo "<input type='text' name='id_noticia' value='$row[id_noticia]' disabled><br>";
            
            echo "<label><img src='../img/$row[imagen]' alt='Lavender Fields'></label><br>";
            echo "<input type='file' name='imagen' id='img' value='$row[imagen]'>";
