...
$clave_capturada = "SELECT * FROM usuarios WHERE usuario = '$usuario' AND pass = '$pass'";
...
if ($pass1 != $pass2) {
    ...
    $nueva_clave = mysqli_query($conexion, "UPDATE  usuarios SET pass = '$pass1' WHERE pass = '$pass' and usuario = '$usuario'");
